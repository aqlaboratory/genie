...
from psddpm.utils.model_io import load_model
...
if __name__ == '__main__':
	...
	parser.add_argument('-r', '--rootdir', type=str, help='Root directory (default to runs/psdppm)', default='runs/psdppm')
	parser.add_argument('-n', '--model_name', type=str, help='Name of PSDPPM model', required=True)
	parser.add_argument('-v', '--model_version', type=int, help='Version of PSDPPM model')
	parser.add_argument('-e', '--model_epoch', type=int, help='Epoch PSDPPM model checkpointed')
